...
public class CameraHefeLive extends OneKeyFilter {
	...
	public Bitmap apply(Context cx, Bitmap bm) {
		...
		CMTProcessor.multiplyEffect(pixels, Layer.getLayerPixels(cx,
				"layers/live_hefe_m", w, h, Layer.Type.NORMAL, 80*255/100), w, h);

		CMTProcessor.overlayAlphaEffect(pixels, Layer.getLayerPixels(cx,
				"layers/live_hefe_o", w, h, Layer.Type.NORMAL), w, h, 20);

		Curve c = new Curve(cx, "curves/live_hefe.dat");
