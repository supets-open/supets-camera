...
public class RSCameraDushiLive extends RSLineFilter {
	...
	public boolean apply(Context cx, String inPath, String outPath, int[] args) {
		mCurve1 = new Curve(cx, "curves/live_dushi1.dat");
		mCurve2 = new Curve(cx, "curves/live_dushi2.dat");
		mLayer = Layer.getLayerImage(cx, "layers/live_dushi", Layer.Type.NORMAL);
	...
	protected void applyLine(Context cx, int[] pixels, int line, int height) {
		...
		CMTProcessor.rsOverlayAlphaEffect(pixels, layerPixels, w, 1, mLayer.getWidth(), 1, 100);
