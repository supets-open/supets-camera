...
public class CameraLomoSceneryLive extends OneKeyFilter{
	...
	public Bitmap apply(Context cx, Bitmap bm) {
		...
		CMTProcessor.overlayAlphaEffect(pixels, Layer.getLayerPixels(cx,
				"layers/live_lomo_scenery", w, h, Layer.Type.NORMAL), w, h, 40);

		Curve c = new Curve(cx, "curves/live_lomo_scenery.dat");
