...
public class RSCameraMeadowLive extends RSLineFilter {
	...
	public boolean apply(Context cx, String inPath, String outPath, int[] args) {
		mCurve1 = new Curve(cx, "curves/live-meadow-1.dat");
		mCurve2 = new Curve(cx, "curves/live-meadow-2.dat");
	...
	protected void applyLine(Context cx, int[] pixels, int line, int height) {
		...
		ImageProcessUtils.saturationPs(pixels, w, 1, -40);
