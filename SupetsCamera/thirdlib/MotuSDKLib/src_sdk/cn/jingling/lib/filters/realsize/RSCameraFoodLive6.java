...
public class RSCameraFoodLive6 extends RSLineFilter {
	...
	public boolean apply(Context cx, String inPath, String outPath, int[] args) {
		mCurve = new Curve(cx, "curves/live_food6.dat");
		mLayer = Layer.getLayerImage(cx, "layers/live_food6", Layer.Type.NORMAL);
