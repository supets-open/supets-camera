...
public class RSCameraRiseLive extends RSLineFilter {
	...
	public boolean apply(Context cx, String inPath, String outPath, int[] args) {
		mCurve = new Curve(cx, "curves/live_rise.dat");
		mLayer = Layer.getLayerImage(cx, "layers/live_rise", Layer.Type.NORMAL);
