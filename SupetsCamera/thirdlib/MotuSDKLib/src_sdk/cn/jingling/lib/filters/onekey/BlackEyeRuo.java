...
public class BlackEyeRuo extends OneKeyFilter {
	...
	public Bitmap apply(Context cx, Bitmap bm) {
		...
		if (rets.humans.length > 0) {
			...
			SmoothSkinProcessor.InitializeCircle(human.leftEye.y, human.leftEye.x, (human.rightEye.x - human.leftEye.x)/3 ,human.rightEye.y, human.rightEye.x, (human.rightEye.x - human.leftEye.x)/3, pixels, w, h, 70);
