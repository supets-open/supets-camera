...
public class RSCameraFoodLive5 extends RSLineFilter {
	...
	public boolean apply(Context cx, String inPath, String outPath, int[] args) {
		mCurve = new Curve(cx, "curves/live_food5.dat");
		mLayer = Layer.getLayerImage(cx, "layers/live_food5", Layer.Type.NORMAL);
