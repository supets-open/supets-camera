...
public class GLStaticFBOBlockRender {
	 ...
	 * @param originalBm
	 */
	private void glSetBitmap(Bitmap originalBm) {
	...
	public Bitmap glDrawFrame(String filterLabel, Bitmap bmBlock, NormalizedRect blockPositionRect) {
...
//		mCurrentLiveFilter.glUpdateBlock(mAppContext, new Point(mImageWidth,
//				mImageHeight), new ViewportRect(0, 0, mImageWidth, mImageHeight), blockPositionRect);
