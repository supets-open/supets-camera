 ...
 * <b>FlowLayout 流式布局</b>
 *<p>
 * 主要功能：能实现子控件自动换行，支持多行。<br/>
 *</p>
 * 用法：与Android的layout用法一样<br/>
 * @author Created by WeiDongliang on 2015/12/24.
 */
public class FlowLayout extends ViewGroup {
     ...
     *是否到达最大行数
     */
    private boolean mIsOverMax = false;
    ...
    /**
     *在onMeasure中遍历所有子View，并获取子View的高度和宽度，然后计算FlowLayout的高度
     *
